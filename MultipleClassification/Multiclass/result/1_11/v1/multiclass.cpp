...
int main() {
	...
	printf("[log]:input node Freq/130;\nhiden nodes 512;\ntiny fix. no adaboost train.\n\
			215 iterator, 20 relax... 0.435/0.591\n");
	...
	//cin >> iterator;
	net.Train(matrix, levels, 215);
#ifdef TEST
	net.Test(tmatrix, tlevels, "out/fnlowbound");
#endif // TEST
#ifdef VALID
